...
Rotating circles with different sizes generated by Javascprit. Using HTML5 element - canvas.
...
- don't try to view live link on your smartphone (it is too slow [yes, even if you have Samsung Galaxy S III])
